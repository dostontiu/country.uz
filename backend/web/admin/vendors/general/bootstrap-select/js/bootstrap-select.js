(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    selectPosition: function () {
      ...
      this.$button.on('click.bs.dropdown.data-apidel', function () {
        if (that.isDisabled()) {
          return;
        }
    ...
    liveSearchListener: function () {
      ...
      this.$searchbox.on('click.bs.dropdown.data-apidel focus.bs.dropdown.data-apidel touchend.bs.dropdown.data-apidel', function (e) {
        e.stopPropagation();
      });
    ...
    toggle: function (e) {
      ...
      this.$button.trigger('click.bs.dropdown.data-apidel');
    },
    ...
    keydown: function (e) {
      ...
      if (
        ...
        that.$button.trigger('click.bs.dropdown.data-apidel');
      }

      if (e.which === keyCodes.ESCAPE && isActive) {
        e.preventDefault();
        that.$button.trigger('click.bs.dropdown.data-apidel').focus();
      }
  ...
  $(document)
    .off('keydown.bs.dropdown.data-apidel')
  ...
  // =====================
  $(window).on('load' + EVENT_KEY + '.data-apidel', function () {
